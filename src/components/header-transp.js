...
const Header2 = ({
    ...
    return (
        <header className="z-50 top-0 left-0 relative bg-transparent">
            ...
            <span className="fa fa-envira fa-4x hidden md:block text-green-400 opacity-70 cursor-pointer hover:opacity-100 focus:opacity-100" aria-hidden="true"></span>
            <span className="fa fa-envira fa-2x mr-2 md:hidden text-green-400 opacity-70 cursor-pointer hover:opacity-100 focus:opacity-100" aria-hidden="true"></span>
                 <span className="md:hidden text-3xl text-white tracking-widest group-hover:text-green-400 ">NL</span>
                 <span className="hidden md:block text-4xl text-white group-hover:text-green-400 md:mt-3 md:ml-2.5">NATIVA LAB</span>
            </div>
            ...
            >
                <ul className="ml-4 flex flex-col items-center md:flex-row md:flex w-full  ">
                    ...
                    <li className="list-none group flex md:mt-2 items-center mb-3 mr-3 md:mr-5 md:font-bold">
                        ...
                        <Link className=" w-full text-opacity-30 uppercase group-hover:text-green-400 cursor-pointer mx-3 mt-2
                        ">
                            Blog
                        </Link>
                    </li>
                    ...
                    <li className="list-none md:mr-5 md:mt-2 group flex items-center bg-transparent mb-3 mr-3">
                        ...
                        <Link className="flex w-full text-base uppercase group-hover:text-green-400 cursor-pointer mx-3 mt-2 md:font-bold 
                        ">
                            Bio
                        </Link>
                    </li>
                    ...
                    ">
                        ...
                        <Link className=" w-full text-base uppercase cursor-pointer group-hover:text-green-400
                            mx-3  mt-2 font-bold
                        ">
                            Contato
                        </Link>
